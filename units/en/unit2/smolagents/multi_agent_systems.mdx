...
model = InferenceClientModel(model_id="Qwen/Qwen3-Coder-480B-A35B-Instruct", provider="together")
```
...
model = InferenceClientModel(
    "Qwen/Qwen3-Coder-480B-A35B-Instruct", provider="together", max_tokens=8096
)
